...
public class KafkaAuthBinding {
  ...
  /*private UserGroupInformation getLoginUser() {
    ...
    private Map<Resource, scala.collection.immutable.Set<Acl>> getAclsForRoles(final List<String> roles) {
        final java.util.Map<Resource, scala.collection.immutable.Set<Acl>> resourceAclsMap = new HashMap<Resource, scala.collection.immutable.Set<Acl>>();
        final java.util.Map<String, scala.collection.immutable.Set<TSentryPrivilege>> rolePrivilegesMap = new HashMap<String, scala.collection.immutable.Set<TSentryPrivilege>>();
        ...
        return scala.collection.JavaConverters.mapAsScalaMapConverter(resourceAclsMap).asScala().toMap(Predef.<Tuple2<Resource, scala.collection.immutable.Set<Acl>>>conforms());
    }
